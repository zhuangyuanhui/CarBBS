...
<li class="ui_2_ul_li  cl border_b_gray">
  <div class="ui_2_ul_li_imgouter  ovh position_a"> <a target="_blank" class="fr ds_inlineB cdg" href="forum.php?mod=viewthread&tid=20"><img src="/home/picture/242d5ad24b1bdca33cf2ac7a8639d39f.jpg" width="220" height="140" /></a> </div>
  <div class="ui_2_ul_li_con">
    <h3 class="clr"><a target="_blank" href="forum.php?mod=viewthread&tid=20" class="ui_colorG">{{$v->title}}</a></h3>
    <div class="ui_2_userinfo  clg cl">
      <span><a href="space-uid-1.html">admin</a></span> <span>发表于</span> <em>2016-04-08 14:09</em> 
    </div>
    <p class="cdg ovh">
{{$v->content}}</p>
    <a class="fr ds_inlineB mr15 cdg" target="_blank" href="forum.php?mod=viewthread&tid=20">阅读全文</a> </div>
</li>
@endforeach
</ul>
...
<div class="part">
  <div class="paddingbox">
    <div class="part__header"><a href="2015.10.3~10.18 台湾单车环岛"><img src="/home/picture/avatar.php" class="loading" width="30" height="30" /></a><a href="space-uid-1.html" class="author">{{$v->getName->uname}}</a></div>
    <div class="text"><a href="thread-20-1-1.html">
      <p><span>{{$v->content}}</span></p>
      </a></div>
    <div class="foot">
      <p>{{date('Y-m-d h:i:s',$v->ctime)}}<span class="reply"><i class="icon-reply"></i>{{$v->clicks}}</span></p>
    </div>
  </div>
</div>
@endforeach
...
<div class="part">
  <div class="paddingbox">
    ...
    <div class="foot">
      <p>{{date('Y-m-d h:i:s',$v->ctime)}}<span class="reply"><i class="icon-reply"></i>2</span></p>
    </div>
  </div>
</div>
@endforeach
