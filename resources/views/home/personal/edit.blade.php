...
<li class="a"><a href="home.php?mod=spacecp&amp;ac=profile&amp;op=base">修改个人资料</a></li>
</ul><iframe id="frame_profile" name="frame_profile" style="display: none"></iframe>

<form action="/home/personal/store/{{$users->id}}" method="post" enctype="multipart/form-data" >
  {{csrf_field()}}
<input type="hidden" value="0408893d" name="formhash">
...
<td id="td_realname">
<input type="text" name="nickname" id="realname" class="px" value="{{$users->nickname}}" tabindex="1"><div class="rq mtn" id="showerror_realname"></div><p class="d"></p></td>
</tr>
<tr id="tr_gender">
...
<td id="td_birthday">
  <input type="text" name="age" value="{{$users->getUserInfo->age}}">
<div class="rq mtn" id="showerror_birthday"></div><p class="d"></p></td>
</tr>
<tr id="tr_realname">
<th id="th_realname">所在地区</th>
<td id="td_realname">
      <select id="Province" runat="server" name="addr" style="width: 90px" ></select>
...
<td id="td_lookingfor">
<input type="text" name="email" id="lookingfor" class="px" value="{{$users->getUserInfo->email}}" tabindex="1"><div class="rq mtn" id="showerror_lookingfor"></div><p class="d"></p></td>
</tr>
<tr id="tr_realname">
<th id="th_realname">个人简介</th>
<td id="td_realname">
<textarea name="intro" style="width: 330px;height: 110px;">{{$users->getUserInfo->intro}}</textarea><div class="rq mtn" id="showerror_realname"></div><p class="d"></p></td>
</tr>
<tr>
<th>&nbsp;</th>
<td colspan="2">
