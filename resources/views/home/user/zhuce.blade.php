      ...
      <div class="wp cl" style="width: 570px; margin: 0 auto; position: relative; z-index: 1000; background: none;"> 
       ...
       <div class="scbar_hot_td" style="float: left; width: 570px; padding: 35px 0;"> 
        <div id="scbar_hot" style="height: auto; padding: 0;"> 
         ...
         <a href="search.php?mod=forum&amp;srchtxt=%BB%EE%B6%AF&amp;formhash=7bb95f5a&amp;searchsubmit=true&amp;source=hotsearch" target="_blank" class="xi2" sc="1" style="  display: inline-block;
...
float: left;
    ...
    line-height: 33px;">活动</a> 
         <a href="search.php?mod=forum&amp;srchtxt=%BD%BB%D3%D1&amp;formhash=7bb95f5a&amp;searchsubmit=true&amp;source=hotsearch" target="_blank" class="xi2" sc="1" style="  display: inline-block;
...
float: left;
    ...
    line-height: 33px;">交友</a> 
         <a href="search.php?mod=forum&amp;srchtxt=discuz&amp;formhash=7bb95f5a&amp;searchsubmit=true&amp;source=hotsearch" target="_blank" class="xi2" sc="1" style="  display: inline-block;
...
jQuery('.quater_search').slideUp(300);
  ...
  <ul class="sub_menu" id="m_menu" style="display: none;"> 
   ...
   <li></li> 
   <li></li> 
   <li><a href="member.php?mod=logging&amp;action=logout&amp;formhash=7bb95f5a">退出</a></li> 
  </ul> 
...
var pwlength = 6;
   ...
   <script src="/home/js/register.js" type="text/javascript"></script> 
     ...
     <div class="mn"> 
      <div class="comForm cl" id="main_message" style="border: 0;"> 
       ...
       <form method="post" autocomplete="off" name="register" id="registerform" enctype="multipart/form-data" onsubmit="checksubmit();return false;" action="member.php?mod=register"> 
          ...
          <div id="reginfo_a"> 
           <div class="rfm"> 
            <table> 
             <tbody>
              <tr> 
               <th><span class="rq">*</span><label for="m7e876">用户名:</label></th> 
               <td><input type="text" id="m7e876" name="" class="px" tabindex="1" value="" autocomplete="off" size="25" maxlength="15" required="" /></td> 
               <td class="tipcol"><i id="tip_m7e876" class="p_tip">用户名由 3 到 15 个字符组成</i><kbd id="chk_m7e876" class="p_chk"></kbd></td> 
              </tr> 
             </tbody>
            </table> 
           </div> 
           <div class="rfm"> 
            <table> 
             <tbody>
              <tr> 
               <th><span class="rq">*</span><label for="h7b79Y">密码:</label></th> 
               <td><input type="password" id="h7b79Y" name="" size="25" tabindex="1" class="px" required="" /></td> 
               <td class="tipcol"><i id="tip_h7b79Y" class="p_tip">请填写密码, 最小长度为 6 个字符</i><kbd id="chk_h7b79Y" class="p_chk"></kbd></td> 
              </tr> 
             </tbody>
            </table> 
           </div> 
           <div class="rfm"> 
            <table> 
             <tbody>
              <tr> 
               <th><span class="rq">*</span><label for="UCi73k">确认密码:</label></th> 
               <td><input type="password" id="UCi73k" name="" size="25" tabindex="1" value="" class="px" required="" /></td> 
               <td class="tipcol"><i id="tip_UCi73k" class="p_tip">请再次输入密码</i><kbd id="chk_UCi73k" class="p_chk"></kbd></td> 
              </tr> 
             </tbody>
            </table> 
           </div> 
           <div class="rfm"> 
            <table> 
             <tbody>
              <tr> 
               <th><span class="rq">*</span><label for="Z61Aw6">Email:</label></th> 
               <td><input type="text" id="Z61Aw6" name="" autocomplete="off" size="25" tabindex="1" class="px" value="" required="" /><br /><em id="emailmore">&nbsp;</em></td> 
               <td class="tipcol"><i id="tip_Z61Aw6" class="p_tip">请输入正确的邮箱地址</i><kbd id="chk_Z61Aw6" class="p_chk"></kbd></td> 
              </tr> 
             </tbody>
            </table> 
           </div> 
           <span id="seccode_cSeL39bp" class="seccode_1"></span> 
           <script type="text/javascript" reload="1">updateseccode('cSeL39bp', '<div class="rfm"><table><tr><th><span class="rq">*</span><sec>: </th><td><sec><br /><sec></td></tr></table></div>', 'member::register');</script> 
          </div> 
         </div> 
        </div> 
            ...
            <tr> 
             ...
             <td> 
              <div id="reginfo_a_btn" class="login_btn"> 
               <em>&nbsp;</em> 
               <button class="pn pnc" id="registerformsubmit" type="submit" name="regsubmit" value="true" tabindex="1">注册</button> 
              </div> </td> 
             <td></td> 
            </tr> 
           </tbody>
        ...
        <div class="login_now cl" style="padding-left: 446px;"> 
         <a href="member.php?mod=logging&amp;action=login&amp;referer=http%3A%2F%2Fquaters.cn%2Fdisplay%2Fche%2F.%2F" onclick="showWindow('login', this.href);return false;" class="xi2"><em style="color: #000000;">已有账号？</em>现在登录</a> 
        </div> 
       </form> 
      </div> 
      <div id="layer_regmessage" class="f_c blr nfl" style="display: none"> 
       ...
       <div id="layer_bbrule" style="display: none"> 
        ...
        <p class="fsb pns cl hm"> <button class="pn pnc" onclick="$('agreebbrule').checked = true;hideMenu('fwin_dialog', 'dialog');"><span>同意</span></button> <button class="pn" onclick="location.href='http://quaters.cn/display/che/'"><span>不同意</span></button> </p> 
       </div> 
       <script type="text/javascript">
...
showDialog($('layer_bbrule').innerHTML, 'info', '玩车达人 网站服务条款');
...
jQuery(function(){
   ...
   <script type="text/javascript">
        var tipsinfo = '50783059|X3.2|0.6||0||0|7|1545410468|25477de315028d5261bd524dd4743751|2';
      </script>
  </div>  
 </body>
</html>