  ...
  <div id="Quater_headtop"> 
   ...
   <div id="Quater_bar" class="cl"> 
    <div class="wp cl"> 
     <!-- 站点LOGO --> 
     <div class="hd_logo"> 
      <h2><a href="portal.php"><img src="picture/logo.png" /></a></h2> 
     </div> 
     <!-- 导航 --> 
     <div class="nav"> 
      <ul> 
...
fObj.href = 'home.php?mod=spacecp&ac=follow&op=add&hash=71293015&fuid='+values['fuid'];
   ...
   <div class="wp cl"> 
    <div class="space_nav cl"> 
     <ul class="tb_1 cl"> 
      <li class="a"><a href="home.php?mod=space&amp;uid=6&amp;do=profile&amp;from=space"><img src="picture/space_profile.png" class="vm" />编辑文章</a></li> 
      <li><a href="home.php?mod=follow&amp;uid=6&amp;do=view&amp;from=space"><img src="picture/space_follow.png" class="vm" />草稿箱</a></li> 
     </ul> 
    </div> 
   </div> 
      ...
      <form>
        ...
        <div>
         ...
         <div >
              ...
              <input type="file"  multiple class="small" name="profiles[]" onchange="preview(this)" id="profiles" placeholder="请选择图片上传" style="display: none;">
              </div>
              <label for="profiles"><div id="picList" style="width:200px;height: 200px;background: url(/home/images/jia.jpg) ">
  ...
  <div id="footer" class="footer cl"> 
   <div class="footer_top cl"> 
    <div class="wp main"> 
     ...
     <div class="scan">
      <img src="picture/w1.png" class="loaded" width="100" /> 
      <p>扫码查看手机版</p> 
     </div> 
     <div class="scan">
      <img src="picture/w2.png" class="loaded" width="100" /> 
      <p>手机版演示站</p> 
     </div> 
    </div> 
   </div> 
