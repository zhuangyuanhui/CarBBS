   ...
   <div id="ct" class="ct1 wp cl" > 
       ...
       <div style="margin-left: 150px;">
         <form action="/home/articles" method="post" enctype="multipart/form-data" >
          ...
          <div class="form-group">
                <label for="exampleInputFile">文章配图</label>
                <div style="width:770px;display: none;">
                <input type="file"  multiple class="small" name="profiles[]" onchange="preview(this)" id="exampleInputFile" placeholder="请选择图片上传" style="display: none;">
                </div>
                <label for="exampleInputFile">
                  <div id="picList" style="width:200px;height: 200px;background: url(/home/images/jia.jpg) "></div>
                </label>
           </div>
          <button type="submit"  style="width: 770px;" class="btn btn-success">提交</button>
        </form>
      </div>
