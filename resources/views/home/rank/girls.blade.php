    ...
    <div class="mn"> 
     ...
     <div class="bm bw0" id="paihang"> 
      ...
      <ul class="tb cl" id="rank_top"> 
       <li @if($type == 0 ) class="a" @endif><a href="/home/rank/girls/{{0}}">浏览量排行</a></li> 
       <li @if($type == 1 ) class="a" @endif><a href="/home/rank/girls/{{1}}">点赞量排行</a></li> 
      </ul> 
            <div >
              ...
              @foreach($data as $key=>$value)
                 <dl class="bbda cl"> 
                  ...
                  <dd class="m avt">
                   <a href="/home/girls/{{$value->id}}" target="_blank" c="1"><img src="/uploads/{{$value->car_pic}}" /></a>
                  </dd> 
                  
                   <a href="/home/girls/{{$value->id}}" target="_blank">{{$value->title}}</a> 
                  </dt> 
                  <dd> 
                   <p> </p> 
                   <p>
    ...
    <div class="appl"> 
     ...
     <div class="tbn"> 
      ...
      <ul id="rank_type" > 
       ...
       <li>           <a href="/home/rank/articles/{{0}}">文章</a></li> 
       <li class="a" ><a href="/home/rank/girls/{{0}}">车模</a></li> 
       <li>           <a href="/home/rank/news/{{0}}">新闻</a></li>  
      </ul> 
     </div>
     <!--[diy=diysidebottom]-->
