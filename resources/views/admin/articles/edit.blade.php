...
@endif
                <div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                        <form class="mws-form" action="/admin/article/{{ $article->id }}" method="post" enctype="multipart/form-data">
                              {{ csrf_field() }}
                              {{ method_field('PUT')}}
                            <div class="mws-form-inline">
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item" style="width:1400px">
                                        <input type="text" class="small" name="title" required value="{{ $article->title }}">
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                   ...
                                   <div class="picList mws-form-row">
                                    ...
                                    @foreach($article->car_pic as $key=>$value)
